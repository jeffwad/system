...
describe("/ui/layouts/stack/proto", function() {
  ...
  it("ui/layouts/stack/proto#__state.control.change__ should set the currentChild to the first", function() {
  ...
  it("ui/layouts/stack/proto#__state.control.change__ should set the currentChild to the second", function() {
  ...
  it("ui/layouts/stack/proto#__state.control.change__ should set the currentChild to the third", function() {
